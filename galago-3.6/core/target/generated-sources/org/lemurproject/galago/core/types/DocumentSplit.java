...
public final class DocumentSplit implements Type<DocumentSplit> {
    ...
    public DocumentSplit(String fileName, String fileType, byte[] startKey, byte[] endKey, int fileId, int totalFileCount) {
    ...
    public String toString() {
        try {
            return String.format("%s,%s,%s,%s,%d,%d",
                                   fileName, fileType, new String(startKey, "UTF-8"), new String(endKey, "UTF-8"), fileId, totalFileCount);
    ...
    public static final class Unordered implements Order<DocumentSplit> {
        ...
        public static final class OrderedWriterClass extends OrderedWriter< DocumentSplit > {
            ...
            public void process(DocumentSplit object) throws IOException {
               ...
               shreddedWriter.processTuple(object.fileName, object.fileType, object.startKey, object.endKey, object.fileId, object.totalFileCount);
               last = object;
            }           
        ...
        public interface ShreddedProcessor extends Step {
            public void processTuple(String fileName, String fileType, byte[] startKey, byte[] endKey, int fileId, int totalFileCount) throws IOException;
            public void close() throws IOException;
        }    
        ...
        public static final class ShreddedWriter implements ShreddedProcessor {
            ...
            public final void processTuple(String fileName, String fileType, byte[] startKey, byte[] endKey, int fileId, int totalFileCount) throws IOException {
                if (lastFlush) {
                    lastFlush = false;
                }
                buffer.processTuple(fileName, fileType, startKey, endKey, fileId, totalFileCount);
                if (buffer.isFull())
                    flush();
            }
        ...
        public static final class ShreddedBuffer {
            ...
            public void processTuple(String fileName, String fileType, byte[] startKey, byte[] endKey, int fileId, int totalFileCount) {
            ...
            public void copyTuples(int endIndex, ShreddedProcessor output) throws IOException {
                while (getReadIndex() < endIndex) {
                   output.processTuple(getFileName(), getFileType(), getStartKey(), getEndKey(), getFileId(), getTotalFileCount());
                   incrementTuple();
                }
            }                                                                           
        ...
        public static final class ShreddedReader implements Step, Comparable<ShreddedReader>, TypeReader<DocumentSplit>, ShreddedSource {
            ...
            public final void fill() throws IOException {
                try {   
                    ...
                    while (!buffer.isFull()) {
                        buffer.processTuple(input.readString(), input.readString(), input.readBytes(), input.readBytes(), input.readInt(), input.readInt());
                        tupleCount++;
                    }
        ...
        public static final class DuplicateEliminator implements ShreddedProcessor {
            ...
            public void processTuple(String fileName, String fileType, byte[] startKey, byte[] endKey, int fileId, int totalFileCount) throws IOException {
                processor.processTuple(fileName, fileType, startKey, endKey, fileId, totalFileCount);
            } 
        ...
        public static final class TupleShredder implements Processor {
            ...
            public void process(DocumentSplit object) throws IOException {                                                                                                                                                   
                boolean processAll = false;
                processor.processTuple(object.fileName, object.fileType, object.startKey, object.endKey, object.fileId, object.totalFileCount);                                         
                last = object;
            }
    ...
    public static final class FileNameStartKeyOrder implements Order<DocumentSplit> {
        ...
        public static final class OrderedWriterClass extends OrderedWriter< DocumentSplit > {
            ...
            public void process(DocumentSplit object) throws IOException {
               ...
               shreddedWriter.processTuple(object.fileType, object.endKey, object.fileId, object.totalFileCount);
               last = object;
            }           
        ...
        public interface ShreddedProcessor extends Step {
            ...
            public void processTuple(String fileType, byte[] endKey, int fileId, int totalFileCount) throws IOException;
            public void close() throws IOException;
        }    
        public interface ShreddedSource extends Step {
        }                                              
        ...
        public static final class ShreddedWriter implements ShreddedProcessor {
            ...
            public final void processTuple(String fileType, byte[] endKey, int fileId, int totalFileCount) throws IOException {
                if (lastFlush) {
                ...
                buffer.processTuple(fileType, endKey, fileId, totalFileCount);
                if (buffer.isFull())
                    flush();
            }
            public final void flushTuples(int pauseIndex) throws IOException {
        ...
        public static final class ShreddedBuffer {
            ...
            public void processTuple(String fileType, byte[] endKey, int fileId, int totalFileCount) {
            ...
            public void copyTuples(int endIndex, ShreddedProcessor output) throws IOException {
                while (getReadIndex() < endIndex) {
                   output.processTuple(getFileType(), getEndKey(), getFileId(), getTotalFileCount());
                   incrementTuple();
                }
            }                                                                           
        ...
        public static final class ShreddedReader implements Step, Comparable<ShreddedReader>, TypeReader<DocumentSplit>, ShreddedSource {
            ...
            public final void fill() throws IOException {
                try {   
                    ...
                    while (!buffer.isFull()) {
                        updateStartKey();
                        buffer.processTuple(input.readString(), input.readBytes(), input.readInt(), input.readInt());
                        tupleCount++;
                    }
                } catch(EOFException e) {}
            }
        ...
        public static final class DuplicateEliminator implements ShreddedProcessor {
            ...
            public void processTuple(String fileType, byte[] endKey, int fileId, int totalFileCount) throws IOException {
                processor.processTuple(fileType, endKey, fileId, totalFileCount);
            } 
        ...
        public static final class TupleShredder implements Processor {
            ...
            public void process(DocumentSplit object) throws IOException {                                                                                                                                                   
                ...
                processor.processTuple(object.fileType, object.endKey, object.fileId, object.totalFileCount);                                         
                last = object;
            }
    ...
    public static final class FileIdOrder implements Order<DocumentSplit> {
        ...
        public static final class OrderedWriterClass extends OrderedWriter< DocumentSplit > {
            ...
            public void process(DocumentSplit object) throws IOException {
               ...
               shreddedWriter.processTuple(object.fileName, object.fileType, object.startKey, object.endKey, object.totalFileCount);
               last = object;
            }           
        ...
        public interface ShreddedProcessor extends Step {
            ...
            public void processTuple(String fileName, String fileType, byte[] startKey, byte[] endKey, int totalFileCount) throws IOException;
            public void close() throws IOException;
        }    
        public interface ShreddedSource extends Step {
        }                                              
        ...
        public static final class ShreddedWriter implements ShreddedProcessor {
            ...
            public final void processTuple(String fileName, String fileType, byte[] startKey, byte[] endKey, int totalFileCount) throws IOException {
                if (lastFlush) {
                    if(buffer.fileIds.size() == 0) buffer.processFileId(lastFileId);
                    lastFlush = false;
                }
                buffer.processTuple(fileName, fileType, startKey, endKey, totalFileCount);
                if (buffer.isFull())
                    flush();
            }
            public final void flushTuples(int pauseIndex) throws IOException {
        ...
        public static final class ShreddedBuffer {
            ...
            public void processTuple(String fileName, String fileType, byte[] startKey, byte[] endKey, int totalFileCount) {
            ...
            public void copyTuples(int endIndex, ShreddedProcessor output) throws IOException {
                while (getReadIndex() < endIndex) {
                   output.processTuple(getFileName(), getFileType(), getStartKey(), getEndKey(), getTotalFileCount());
                   incrementTuple();
                }
            }                                                                           
        ...
        public static final class ShreddedReader implements Step, Comparable<ShreddedReader>, TypeReader<DocumentSplit>, ShreddedSource {
            ...
            public final void fill() throws IOException {
                try {   
                    ...
                    while (!buffer.isFull()) {
                        updateFileId();
                        buffer.processTuple(input.readString(), input.readString(), input.readBytes(), input.readBytes(), input.readInt());
                        tupleCount++;
                    }
                } catch(EOFException e) {}
            }
        ...
        public static final class DuplicateEliminator implements ShreddedProcessor {
            ...
            public void processTuple(String fileName, String fileType, byte[] startKey, byte[] endKey, int totalFileCount) throws IOException {
                processor.processTuple(fileName, fileType, startKey, endKey, totalFileCount);
            } 
        ...
        public static final class TupleShredder implements Processor {
            ...
            public void process(DocumentSplit object) throws IOException {                                                                                                                                                   
                ...
                processor.processTuple(object.fileName, object.fileType, object.startKey, object.endKey, object.totalFileCount);                                         
                last = object;
            }
