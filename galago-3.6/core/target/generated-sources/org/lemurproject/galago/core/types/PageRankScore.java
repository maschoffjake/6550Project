...
public final class PageRankScore implements Type<PageRankScore> {
    ...
    public static final class DocNameOrder implements Order<PageRankScore> {
        ...
        public Comparator<PageRankScore> greaterThan() {
            return new Comparator<PageRankScore>() {
                public int compare(PageRankScore one, PageRankScore two) {
                    int result = 0;
                    do {
                        result = + Utility.compare(one.docName, two.docName);
                        if(result != 0) break;
                    } while (false);
                    return -result;
                }
        ...
        public static final class OrderedWriterClass extends OrderedWriter< PageRankScore > {
            ...
            public void process(PageRankScore object) throws IOException {
               ...
               if (processAll || last == null || 0 != Utility.compare(object.docName, last.docName)) { processAll = true; shreddedWriter.processDocName(object.docName); }
            ...
            public void copyUntilDocName(ShreddedBuffer other, ShreddedProcessor output) throws IOException {
                while (!isAtEnd()) {
                    if (other != null) {   
                        ...
                        int c = + Utility.compare(getDocName(), other.getDocName());
        ...
        public static final class ShreddedReader implements Step, Comparable<ShreddedReader>, TypeReader<PageRankScore>, ShreddedSource {
            ...
            public final int compareTo(ShreddedReader other) {
                ...
                int result = 0;
                do {
                    result = + Utility.compare(buffer.getDocName(), otherBuffer.getDocName());
                    if(result != 0) break;
                } while (false);                                             
        ...
        public static final class DuplicateEliminator implements ShreddedProcessor {
            ...
            public void processDocName(String docName) throws IOException {  
                if (docNameProcess || Utility.compare(docName, last.docName) != 0) {
        ...
        public static final class TupleShredder implements Processor {
            ...
            public void process(PageRankScore object) throws IOException {                                                                                                                                                   
                boolean processAll = false;
                if(last == null || Utility.compare(last.docName, object.docName) != 0 || processAll) { processor.processDocName(object.docName); processAll = true; }
    ...
    public static final class ScoreOrder implements Order<PageRankScore> {
        ...
        public Comparator<PageRankScore> greaterThan() {
            return new Comparator<PageRankScore>() {
                public int compare(PageRankScore one, PageRankScore two) {
                    int result = 0;
                    do {
                        result = + Utility.compare(one.score, two.score);
                        if(result != 0) break;
                    } while (false);
                    return -result;
                }
        ...
        public static final class OrderedWriterClass extends OrderedWriter< PageRankScore > {
            ...
            public void process(PageRankScore object) throws IOException {
               boolean processAll = false;
               if (processAll || last == null || 0 != Utility.compare(object.score, last.score)) { processAll = true; shreddedWriter.processScore(object.score); }
        ...
        public static final class ShreddedBuffer {
            ...
            public void copyUntilScore(ShreddedBuffer other, ShreddedProcessor output) throws IOException {
                while (!isAtEnd()) {
                    if (other != null) {   
                        assert !other.isAtEnd();
                        int c = + Utility.compare(getScore(), other.getScore());
        ...
        public static final class ShreddedReader implements Step, Comparable<ShreddedReader>, TypeReader<PageRankScore>, ShreddedSource {
            ...
            public final int compareTo(ShreddedReader other) {
                ...
                int result = 0;
                do {
                    result = + Utility.compare(buffer.getScore(), otherBuffer.getScore());
                    if(result != 0) break;
                } while (false);                                             
        ...
        public static final class DuplicateEliminator implements ShreddedProcessor {
            ...
            public void processScore(double score) throws IOException {  
                if (scoreProcess || Utility.compare(score, last.score) != 0) {
                    last.score = score;
        ...
        public static final class TupleShredder implements Processor {
            ...
            public void process(PageRankScore object) throws IOException {                                                                                                                                                   
                boolean processAll = false;
                if(last == null || Utility.compare(last.score, object.score) != 0 || processAll) { processor.processScore(object.score); processAll = true; }
