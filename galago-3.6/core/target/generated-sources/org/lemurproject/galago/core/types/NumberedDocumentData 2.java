...
public final class NumberedDocumentData implements Type<NumberedDocumentData> {
    ...
    public NumberedDocumentData(String identifier, String fieldList, String url, long number, int textLength) {
    ...
    public static final class NumberOrder implements Order<NumberedDocumentData> {
        ...
        public static final class OrderedWriterClass extends OrderedWriter< NumberedDocumentData > {
        ...
        public static final class ShreddedCombiner implements ReaderSource<NumberedDocumentData>, ShreddedSource {
        ...
        public static final class ShreddedReader implements Step, Comparable<ShreddedReader>, TypeReader<NumberedDocumentData>, ShreddedSource {
            public ShreddedProcessor processor;
    ...
    public static final class IdentifierOrder implements Order<NumberedDocumentData> {
        public int hash(NumberedDocumentData object) {
            int h = 0;
        ...
        public interface ShreddedProcessor extends Step {
            ...
            public void processTuple(String fieldList, String url, long number, int textLength) throws IOException;
            public void close() throws IOException;
        }    
        public interface ShreddedSource extends Step {
        }                                              
        ...
        public static final class ShreddedWriter implements ShreddedProcessor {
            ...
            public final void processTuple(String fieldList, String url, long number, int textLength) throws IOException {
                if (lastFlush) {
        ...
        public static final class ShreddedBuffer {
            ...
            public void processTuple(String fieldList, String url, long number, int textLength) {
        ...
        public static final class ShreddedReader implements Step, Comparable<ShreddedReader>, TypeReader<NumberedDocumentData>, ShreddedSource {
            ...
            public final void fill() throws IOException {
                try {   
                    ...
                    while (!buffer.isFull()) {
                        updateIdentifier();
                        buffer.processTuple(input.readString(), input.readString(), input.readLong(), input.readInt());
                        tupleCount++;
                    }
                } catch(EOFException e) {}
            }
    ...
    public static final class UrlOrder implements Order<NumberedDocumentData> {
        public int hash(NumberedDocumentData object) {
            int h = 0;
        ...
        public interface ShreddedProcessor extends Step {
            ...
            public void processTuple(String identifier, String fieldList, long number, int textLength) throws IOException;
            public void close() throws IOException;
        }    
        public interface ShreddedSource extends Step {
        }                                              
        ...
        public static final class ShreddedWriter implements ShreddedProcessor {
            ...
            public final void processTuple(String identifier, String fieldList, long number, int textLength) throws IOException {
                if (lastFlush) {
        ...
        public static final class ShreddedBuffer {
            ...
            public void processTuple(String identifier, String fieldList, long number, int textLength) {
                assert urls.size() > 0;
                identifiers[writeTupleIndex] = identifier;
                fieldLists[writeTupleIndex] = fieldList;
                numbers[writeTupleIndex] = number;
