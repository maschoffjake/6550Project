...
public final class ExtractedLinkIndri implements Type<ExtractedLinkIndri> {
    ...
    public static final class SrcNameOrder implements Order<ExtractedLinkIndri> {
        ...
        public Comparator<ExtractedLinkIndri> greaterThan() {
            return new Comparator<ExtractedLinkIndri>() {
                public int compare(ExtractedLinkIndri one, ExtractedLinkIndri two) {
                    int result = 0;
                    do {
                        result = + Utility.compare(one.srcName, two.srcName);
                        if(result != 0) break;
                    } while (false);
                    return -result;
                }
        ...
        public static final class OrderedWriterClass extends OrderedWriter< ExtractedLinkIndri > {
            ...
            public void process(ExtractedLinkIndri object) throws IOException {
               boolean processAll = false;
               if (processAll || last == null || 0 != Utility.compare(object.srcName, last.srcName)) { processAll = true; shreddedWriter.processSrcName(object.srcName); }
        ...
        public static final class ShreddedBuffer {
            ...
            public void copyUntilSrcName(ShreddedBuffer other, ShreddedProcessor output) throws IOException {
                while (!isAtEnd()) {
                    if (other != null) {   
                        assert !other.isAtEnd();
                        int c = + Utility.compare(getSrcName(), other.getSrcName());
        ...
        public static final class ShreddedReader implements Step, Comparable<ShreddedReader>, TypeReader<ExtractedLinkIndri>, ShreddedSource {
            ...
            public final int compareTo(ShreddedReader other) {
                ...
                int result = 0;
                do {
                    result = + Utility.compare(buffer.getSrcName(), otherBuffer.getSrcName());
                    if(result != 0) break;
                } while (false);                                             
        ...
        public static final class DuplicateEliminator implements ShreddedProcessor {
            ...
            public void processSrcName(String srcName) throws IOException {  
                if (srcNameProcess || Utility.compare(srcName, last.srcName) != 0) {
                    last.srcName = srcName;
        ...
        public static final class TupleShredder implements Processor {
            ...
            public void process(ExtractedLinkIndri object) throws IOException {                                                                                                                                                   
                boolean processAll = false;
                if(last == null || Utility.compare(last.srcName, object.srcName) != 0 || processAll) { processor.processSrcName(object.srcName); processAll = true; }
    ...
    public static final class DestNameOrder implements Order<ExtractedLinkIndri> {
        public int hash(ExtractedLinkIndri object) {
            int h = 0;
            h += Utility.hash(object.destName);
            return h;
        } 
        public Comparator<ExtractedLinkIndri> greaterThan() {
            return new Comparator<ExtractedLinkIndri>() {
                public int compare(ExtractedLinkIndri one, ExtractedLinkIndri two) {
                    int result = 0;
                    do {
                        result = + Utility.compare(one.destName, two.destName);
                        if(result != 0) break;
                    } while (false);
                    return -result;
                }
        ...
        public static final class OrderedWriterClass extends OrderedWriter< ExtractedLinkIndri > {
            ...
            public void process(ExtractedLinkIndri object) throws IOException {
               boolean processAll = false;
               if (processAll || last == null || 0 != Utility.compare(object.destName, last.destName)) { processAll = true; shreddedWriter.processDestName(object.destName); }
        ...
        public static final class ShreddedBuffer {
            ...
            public void copyUntilDestName(ShreddedBuffer other, ShreddedProcessor output) throws IOException {
                while (!isAtEnd()) {
                    if (other != null) {   
                        assert !other.isAtEnd();
                        int c = + Utility.compare(getDestName(), other.getDestName());
        ...
        public static final class ShreddedReader implements Step, Comparable<ShreddedReader>, TypeReader<ExtractedLinkIndri>, ShreddedSource {
            ...
            public final int compareTo(ShreddedReader other) {
                ...
                int result = 0;
                do {
                    result = + Utility.compare(buffer.getDestName(), otherBuffer.getDestName());
                    if(result != 0) break;
                } while (false);                                             
        ...
        public static final class DuplicateEliminator implements ShreddedProcessor {
            ...
            public void processDestName(String destName) throws IOException {  
                if (destNameProcess || Utility.compare(destName, last.destName) != 0) {
                    last.destName = destName;
        ...
        public static final class TupleShredder implements Processor {
            ...
            public void process(ExtractedLinkIndri object) throws IOException {                                                                                                                                                   
                boolean processAll = false;
                if(last == null || Utility.compare(last.destName, object.destName) != 0 || processAll) { processor.processDestName(object.destName); processAll = true; }
    ...
    public static final class FilePathFileLocationOrder implements Order<ExtractedLinkIndri> {
        public int hash(ExtractedLinkIndri object) {
            int h = 0;
            h += Utility.hash(object.filePath);
            h += Utility.hash(object.fileLocation);
            return h;
        } 
        public Comparator<ExtractedLinkIndri> greaterThan() {
            return new Comparator<ExtractedLinkIndri>() {
                public int compare(ExtractedLinkIndri one, ExtractedLinkIndri two) {
                    int result = 0;
                    do {
                        result = + Utility.compare(one.filePath, two.filePath);
                        if(result != 0) break;
                        result = + Utility.compare(one.fileLocation, two.fileLocation);
                        if(result != 0) break;
                    } while (false);
                    return -result;
                }
        ...
        public static final class OrderedWriterClass extends OrderedWriter< ExtractedLinkIndri > {
            ...
            public void process(ExtractedLinkIndri object) throws IOException {
               boolean processAll = false;
               if (processAll || last == null || 0 != Utility.compare(object.filePath, last.filePath)) { processAll = true; shreddedWriter.processFilePath(object.filePath); }
               if (processAll || last == null || 0 != Utility.compare(object.fileLocation, last.fileLocation)) { processAll = true; shreddedWriter.processFileLocation(object.fileLocation); }
        ...
        public static final class ShreddedBuffer {
            ...
            public void copyUntilFilePath(ShreddedBuffer other, ShreddedProcessor output) throws IOException {
                while (!isAtEnd()) {
                    if (other != null) {   
                        assert !other.isAtEnd();
                        int c = + Utility.compare(getFilePath(), other.getFilePath());
            ...
            public void copyUntilFileLocation(ShreddedBuffer other, ShreddedProcessor output) throws IOException {
                while (!isAtEnd()) {
                    if (other != null) {   
                        assert !other.isAtEnd();
                        int c = + Utility.compare(getFileLocation(), other.getFileLocation());
        ...
        public static final class ShreddedReader implements Step, Comparable<ShreddedReader>, TypeReader<ExtractedLinkIndri>, ShreddedSource {
            ...
            public final int compareTo(ShreddedReader other) {
                ...
                int result = 0;
                do {
                    result = + Utility.compare(buffer.getFilePath(), otherBuffer.getFilePath());
                    if(result != 0) break;
                    result = + Utility.compare(buffer.getFileLocation(), otherBuffer.getFileLocation());
                    if(result != 0) break;
                } while (false);                                             
        ...
        public static final class DuplicateEliminator implements ShreddedProcessor {
            ...
            public void processFilePath(String filePath) throws IOException {  
                if (filePathProcess || Utility.compare(filePath, last.filePath) != 0) {
                    last.filePath = filePath;
            ...
            public void processFileLocation(long fileLocation) throws IOException {  
                if (fileLocationProcess || Utility.compare(fileLocation, last.fileLocation) != 0) {
                    last.fileLocation = fileLocation;
        ...
        public static final class TupleShredder implements Processor {
            ...
            public void process(ExtractedLinkIndri object) throws IOException {                                                                                                                                                   
                boolean processAll = false;
                if(last == null || Utility.compare(last.filePath, object.filePath) != 0 || processAll) { processor.processFilePath(object.filePath); processAll = true; }
                if(last == null || Utility.compare(last.fileLocation, object.fileLocation) != 0 || processAll) { processor.processFileLocation(object.fileLocation); processAll = true; }
